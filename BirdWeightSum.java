...
public class BirdWeightSum {
    ...
    public static class BirdWeightMapper extends Mapper<Object, Text, Text, IntWritable> {
    ...
    public static class BirdWeightReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "BirdWeightMapper");
